...
#plot combined
rrdtool graph chargercomb7d.png --imgformat=PNG --start=-7day --end=+1hours --width=1000 --height=600 \
...
#plot voltages
rrdtool graph chargervolt7d.png --imgformat=PNG --start=-7day --end=+1hours --width=1000 --height=600 \
--vertical-label "Volt" \
--alt-autoscale-max \
--slope-mode \
--font TITLE:12: \
...
#Plot currents
rrdtool graph chargercurrent7d.png --imgformat=PNG --start=-7day --end=+1hours --width=1000 --height=600 \
...
#Plot solarstats
rrdtool graph chargersolar7d.png --imgformat=PNG --start=-7day --end=+1hours --width=1000 --height=600 \
--vertical-label "Volt" \
--right-axis 1:20 \
...
#plot Wattages		   
rrdtool graph chargerwatts7d.png --imgformat=PNG --start=-7day --end=+1hours --width=1000 --height=600 \
