...
#plot combined
rrdtool graph chargercomb24.png --imgformat=PNG --start=-1day --end=+1hours --width=1000 --height=600 \
...
#plot voltages
rrdtool graph chargervolt24.png --imgformat=PNG --start=-1day --end=+1hours --width=1000 --height=600 \
--vertical-label "Volt" \
--alt-autoscale-max \
--slope-mode \
--font TITLE:12: \
...
#Plot currents
rrdtool graph chargercurrent24.png --imgformat=PNG --start=-1day --end=+1hours --width=1000 --height=600 \
...
#Plot solarstats
rrdtool graph chargersolar24.png --imgformat=PNG --start=-1day --end=+1hours --width=1000 --height=600 \
--vertical-label "Volt" \
--right-axis 1:20 \
...
#plot Wattages		   
rrdtool graph chargerwatts24.png --imgformat=PNG --start=-1day --end=+1hours --width=1000 --height=600 \
